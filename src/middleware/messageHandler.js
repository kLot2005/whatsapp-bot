...
const STATE_CONTEXT = {
  [STATES.AWAITING_START]: 'Клиент ещё не начал анкету. Нужно чтобы он нажал кнопку "Начать".',
  [STATES.AWAITING_CONSENT]: 'Клиент должен дать согласие на обработку персональных данных. Кнопки: "Согласен(на)" или "Отказ".',
  [STATES.AWAITING_NAME]: 'Ожидаем ФИО клиента (Фамилия Имя Отчество). Верни к вводу ФИО.',
  [STATES.AWAITING_IIN]: 'Ожидаем ИИН клиента — 12-значный идентификационный номер Казахстана. Верни к вводу ИИН.',
  [STATES.AWAITING_PROPERTY]: 'Ожидаем ответ есть ли у клиента недвижимость или транспортное средство. Кнопки: "Есть имущество" или "Нет имущества".',
  [STATES.AWAITING_DEBT]: 'Ожидаем общую сумму долгов клиента в тенге (только цифры). Верни к вводу суммы долга.',
  [STATES.AWAITING_PROBLEM]: 'Ожидаем описание проблемы клиента (коллекторы, суд, арест счёта и т.д.). Верни к описанию ситуации.',
  [STATES.COMPLETED]: 'Анкета заполнена. Юрист скоро свяжется. Можешь подробно отвечать на любые юридические вопросы клиента.',
};
